		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicação Teste BAS",
									"targetURL": "#mentoriafiorikazkaui5242ads-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikazkaui5242ads-display": {
								"semanticObject": "mentoriafiorikazkaui5242ads",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.zkaui5242ads",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/zkaui5242ads")
								}
							}
						}
					}
